    ...
    '**': # any source branch 
      - step:
          ...
          script:
            ...
            - npm install
            - node dist/index.js --user $BB_USER --password $BB_APP_PASSWORD --repo $BITBUCKET_REPO_SLUG --commit $BITBUCKET_COMMIT --workspace $BITBUCKET_WORKSPACE --report "example_reports/jtest-example.sarif"
```
